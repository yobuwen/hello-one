...
module systolic_array_load_a14 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
output   start_out;
output   start_write;
output  [31:0] A_nxt14_din;
input   A_nxt14_full_n;
output   A_nxt14_write;
...
assign A_1_address0 = k_cast_fu_84_p1;

assign A_nxt14_din = A_1_q0;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln31_reg_94 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == A_nxt14_full_n));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln31_reg_94 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == A_nxt14_full_n));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln31_reg_94 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == A_nxt14_full_n));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln31_reg_94 == 1'd0) & (1'b0 == A_nxt14_full_n));
end
...
endmodule //systolic_array_load_a14
