...
module systolic_array_load_a13 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
assign A_0_address0 = k_cast_fu_84_p1;

assign A_nxt_din = A_0_q0;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln31_reg_94 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == A_nxt_full_n));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln31_reg_94 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == A_nxt_full_n));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln31_reg_94 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == A_nxt_full_n));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln31_reg_94 == 1'd0) & (1'b0 == A_nxt_full_n));
end
...
endmodule //systolic_array_load_a13
