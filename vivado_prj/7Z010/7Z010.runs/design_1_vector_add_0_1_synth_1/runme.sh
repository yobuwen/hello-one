...
HD_PWD='/home/yobuwen/hello-one/vivado_prj/7Z010/7Z010.runs/design_1_vector_add_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_vector_add_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_vector_add_0_1.tcl
