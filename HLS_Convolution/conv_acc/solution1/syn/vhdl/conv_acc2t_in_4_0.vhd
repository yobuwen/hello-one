...
entity conv_acc2t_in_4_0_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of conv_acc2t_in_4_0_rom is 
...
architecture arch of conv_acc2t_in_4_0 is
    component conv_acc2t_in_4_0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    conv_acc2t_in_4_0_rom_U :  component conv_acc2t_in_4_0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
