; ModuleID = '/home/yobuwen/hello-one/HLS_Convolution/conv_acc/solution4/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_conv_acc4t_ir(float* %In_ddr, float* %W_ddr, float* %Out_ddr) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_conv_acc4t_hw(float* %3, float* %4, float* %5)
...
declare void @apatb_conv_acc4t_hw(float*, float*, float*)

define void @conv_acc4t_hw_stub_wrapper(float*, float*, float*) #5 {
entry:
