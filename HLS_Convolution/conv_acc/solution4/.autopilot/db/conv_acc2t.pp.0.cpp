 ...
 OUTPUT_CHANNEL_TILING:
    for (int cho = 0; cho < 8; cho+=4)
    {
        ...
        for (int chi = 0; chi < 8; chi+=4)
        {
            ...
            {
                VITIS_LOOP_52_1: for (int L_ci = 0; L_ci < 16; L_ci++)
                {
                    VITIS_LOOP_54_2: for (int L_chi = 0; L_chi < 4; L_chi++)
                    {
            ...
            {
                VITIS_LOOP_63_3: for (int L_chi = 0; L_chi < 4; L_chi++)
                {
                    VITIS_LOOP_65_4: for (int L_kr = 0; L_kr < 4; L_kr++)
                    {
                        VITIS_LOOP_67_5: for (int L_kr = 0; L_kr < 4; L_kr++)
                        {
...
#pragma HLS PIPELINE
 Output_column:
        ...
        {
            VITIS_LOOP_108_6: for (int L_co = 0; L_co < 14; L_co++)
            {
                VITIS_LOOP_110_7: for (int L_cho = 0; L_cho < 4; L_cho++)
                {
