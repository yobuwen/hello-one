...
# 2 "source/conv_acc4t.cpp" 2
# 21 "source/conv_acc4t.cpp"
void load_in(float *In_ddr, float in[4][16][16])
{
    INDATA_LOAD:
    for (int L_ri = 0; L_ri < 16; L_ri++)
    {
        VITIS_LOOP_26_1: for (int L_ci = 0; L_ci < 16; L_ci++)
        {
            VITIS_LOOP_28_2: for (int L_chi = 0; L_chi < 4; L_chi++)
            {
...
void load_w(float *W_ddr, float w[4][4][3][3])
{
    ...
    {
        VITIS_LOOP_40_1: for (int L_chi = 0; L_chi < 4; L_chi++)
        {
            VITIS_LOOP_42_2: for (int L_kr = 0; L_kr < 4; L_kr++)
            {
                VITIS_LOOP_44_3: for (int L_kr = 0; L_kr < 4; L_kr++)
                {
...
void offload_out(float *Out_ddr, float out[4][14][14])
{
    ...
    {
        VITIS_LOOP_57_1: for (int L_co = 0; L_co < 14; L_co++)
        {
            VITIS_LOOP_59_2: for (int L_cho = 0; L_cho < 4; L_cho++)
            {
...
__attribute__((sdx_kernel("conv_acc4t", 0))) void conv_acc4t(float *In_ddr, float *W_ddr, float *Out_ddr)
{
#pragma HLS TOP name=conv_acc4t
# 111 "source/conv_acc4t.cpp"
