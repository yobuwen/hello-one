...
# Path of this script: /home/yobuwen/hello-one/ultra96_ptlinux/vitis/hello_a53_system/_ide/scripts/systemdebugger_hello_a53_system_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source /home/yobuwen/hello-one/ultra96_ptlinux/vitis/hello_a53_system/_ide/scripts/systemdebugger_hello_a53_system_standalone.tcl
# 
...
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
dow /home/yobuwen/hello-one/ultra96_ptlinux/vitis/hello_a53/Debug/hello_a53.elf
targets -set -nocase -filter {name =~ "*R5*#0"}
rst -processor
dow /home/yobuwen/hello-one/ultra96_ptlinux/vitis/empty_hello_r5/Debug/empty_hello_r5.elf
