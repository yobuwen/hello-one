...
$(ObjDir)/test_gemv.c_pre.c.tb.o : test_gemv.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) test_gemv.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/example_gemv.c_pre.c.tb.o : example_gemv.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) example_gemv.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
