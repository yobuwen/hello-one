...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "example_gemv.autotvin.dat"
	set constFileTvOut       "example_gemv.autotvout.dat"
	set constFileHdlTvIn     "example_gemv.autohdltvin.dat"
	set constFileHdlTvOut    "example_gemv.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
