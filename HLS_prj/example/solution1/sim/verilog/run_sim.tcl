...
if {[file isfile example_gemv.autotvin.dat]} {
	file delete -force example_gemv.autotvin.dat
}

if {[file isfile example_gemv.autotvout.dat]} {
	file delete -force example_gemv.autotvout.dat
}
