...
`define AUTOTB_DUT      example_gemv
`define AUTOTB_DUT_INST AESL_inst_example_gemv
`define AUTOTB_TOP      apatb_example_gemv_top
`define AUTOTB_LAT_RESULT_FILE "example_gemv.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "example_gemv.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_example_gemv_top
...
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.example_gemv.autotvin_A.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.example_gemv.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "../tv/rtldatafile/rtl.example_gemv.autotvin_c.dat"
`define AUTOTB_TVOUT_c  "../tv/cdatafile/c.example_gemv.autotvout_c.dat"
`define AUTOTB_TVOUT_c_out_wrapc  "../tv/rtldatafile/rtl.example_gemv.autotvout_c.dat"
module `AUTOTB_TOP;
