...
__attribute__((sdx_kernel("example_gemv", 0))) void example_gemv(data_type A[5 * 5], data_type b[5], data_type c[5]){_ssdm_SpecArrayDimSize(A, 25);_ssdm_SpecArrayDimSize(b, 5);_ssdm_SpecArrayDimSize(c, 5);
#pragma HLS TOP name=example_gemv
# 5 "example_gemv.c"
